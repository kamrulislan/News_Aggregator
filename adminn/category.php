      ...
      <div class="col-md-8">
        ...
        <div class="post-container">
          ...
          if (isset($_GET['cid'])) {
            ...
            $query_cat = "SELECT * FROM news_cat WHERE news_cat_id = {$rcv_cid}";
            $result_cat = mysqli_query($db_conn, $query_cat) or die("Query Failed.");
            $row_new = mysqli_fetch_assoc($result_cat);

          ?>

            <h2 class="page-heading"><?php echo strtoupper($row_new['news_cat_name']); ?></h2>
                      ...
                      <div class="inner-content clearfix">
                        ...
                        <div class="post-information">
                          <span>
                            ...
                            <a href='category.php?cid=<?php echo $row['category'] ?>'><?php echo $row['news_cat_name'] ?></a>
                          </span>
                          <span>
                            <i class="fa fa-user" aria-hidden="true"></i>
                            <a href='author.php'><?php echo $row['user_username'] ?></a>
                          </span>
                          <span>
